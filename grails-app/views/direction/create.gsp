...
<html>
	...
	<body>
		<a href="#create-direction" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-direction" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:directionInstance, action:'save']" >
				<fieldset class="form">
